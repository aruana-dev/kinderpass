...
class OnboardingStep1Widget extends StatefulWidget {
  ...
  @override
  _OnboardingStep1WidgetState createState() => _OnboardingStep1WidgetState();
}
              ...
              child: Column(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        'Dein neues Konto einrichten',
                        style: FlutterFlowTheme.of(context).headlineLarge,
                      ),
                      Text(
                        'Nimm dir einen Moment Zeit, um dein neues Konto einzurichten.',
                      ...
                      onPressed: () async {
                        if (currentUserDocument!.roles.isClient &&
                          ...
                          context.goNamed(
                            ...
                            queryParameters: {
                              'log': serializeParam(
                                'onboardingStep1, client and manager',
                                ParamType.String,
                              ),
                            }.withoutNulls,
                            ...
                            !currentUserDocument!.roles.isManager) {
                          context.goNamed('ClientOnboardingStep1-2');
                        } else if (!currentUserDocument!.roles.isClient &&
                            currentUserDocument!.roles.isManager) {
                          context.goNamed('ManagerOnboardingStep1-2');
                        } else {
                          context.goNamed(
                            'ErrorPage',
                            queryParameters: {
                              'log': serializeParam(
                                'onboardingStep1, else',
                                ParamType.String,
                              ),
                            }.withoutNulls,
                            extra: <String, dynamic>{
