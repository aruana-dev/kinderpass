...
import 'schema/child_profiles_record.dart';
...
export 'schema/child_profiles_record.dart';
...
/// Functions to query ChildProfilesRecords (as a Stream and as a Future).
Future<int> queryChildProfilesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChildProfilesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChildProfilesRecord>> queryChildProfilesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChildProfilesRecord.collection,
      ChildProfilesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChildProfilesRecord>> queryChildProfilesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
