...
const _kProdStripePublishableKey =
    'pk_live_51O21h5EM7fLaJTBt11Fxl6z2Msp6EFHEw17GqU3Ki0OgzdW5djYDEEai2cQetqWurKQvHac9V3n0LQGisoCVEdEQ00BxDKgKev';
const _kTestStripePublishableKey =
    'pk_test_51O21h5EM7fLaJTBt87jsXDLVH1ZEVNkG5JqaMhpIaLPV9y0WwgcusVHwiTNJdEhkTeBbdnUSaxvz5vNZICcuhqHt00cHebp8Jr';
const _kAppleMerchantId = 'merchant.ch.aruana.kinderpass';
  ...
  try {
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName: 'kinderpass',
